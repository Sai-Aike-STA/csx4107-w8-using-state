...
1. `CounterDemo.jsx` shows how `useState` remembers a number and how a setter updates the UI.
2. `RegisterDemo.jsx` shows a controlled input whose value is stored in state.
